        ...
        return (
            <div className={Styles.container}>
                ...
                <div className={Styles.information_wrapper}>
                    <ExpandableInformation showDelay={700} title="SPECIALISTS" information="A & S Engineering is a Rolls-Royce and Bentley Specialist only working on classic Rolls-Royce and Bentley vehicles. We have extensive experience in all pre and post war classic and vintage Rolls-Royce and Bently cars, from 1900 to 1980, including the Sliver Ghost and the Shadow 2." />
                    <ExpandableInformation showDelay={1200} title="CUSTOMER FOCUSED" information="A small company that provides a tailor-made service to every clients' requirements. A & S Engineering provide all mechanical restoration work from chassis upwards. Also, bodywork, re-trim work and upholstery work can be carried out by arrangement" />
                    <ExpandableInformation showDelay={1500} title="EXPERIENCED" information="Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Volutpat maecenas volutpat blandit aliquam etiam erat. Pellentesque eu tincidunt tortor aliquam nulla facilisi. Enim eu turpis egestas pretium aenean." />
                </div>
            </div>
        )
    }
